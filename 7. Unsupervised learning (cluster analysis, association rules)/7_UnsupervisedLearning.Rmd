...
- Or, clustering is a great way to group and target your customer from the general public:

![example2](https://qph.fs.quoracdn.net/main-qimg-5d2236c938bfe7ad21ac395e29fb2c69)
...
If you wish more, the package `NbClust` provides 30 indexes for determining the optimal number of clusters in a data set.
